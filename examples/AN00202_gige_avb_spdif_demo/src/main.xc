...
int main(void)
{
  ...
  par
  {
    ...
    on tile[0]: {
      ...
      configure_clock_src(clk_spdif_mclk, p_i2s_mclk);
      spdif_tx_set_clock_delay(clk_spdif_mclk);
      start_clock(clk_spdif_mclk);
      ...
      par {
          ...
          spdif_tx(c_spdif, p_spdif_tx, clk_spdif_mclk);
      }
    }
    ...
    on tile[0]: buffer_manager_to_i2s(i_i2s, c_audio, i_i2c[I2S_TO_I2C], c_sound_activity, 0xC,
                                                     i_gpio[0], i_gpio[1], i_gpio[2], i_gpio[3]);
